...
import officeLocations from '../research/office-locations/locations.json';
...
const ui=new UI(entities,relationships,scene,id=>{ui.showEntity(id);ui.renderEntityProfile(id);ui.renderModelPortfolio(id)},officeLocations.locations);
